...
const About = () => {
    ...
    <div className='about'>
        ...
        <h3 className='mental-title'> - Mental Benefits:</h3>
        <ol className='mental-list'>
        ...
        <h3 className='physical-title'> - Physical Benefits:</h3>
        <ol className='physical-list'>
